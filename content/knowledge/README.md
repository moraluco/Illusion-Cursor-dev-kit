...
| [16-blueprint-query-fast-indexer-retro.md](16-blueprint-query-fast-indexer-retro.md) | 复盘：Blueprint 在线查询与 Indexer 的综合测试、性能评估与下一步优化方向（含常驻 client 等） |
...
|------|----------------|----------|----------------|
| 术语 **Harness**（工作区约束 Agent 的整体环境） | `harness` | — | `.cursor/rules/harness.mdc` |
...
| UE 自动化测试 / Bridge / Editor-Cmd / 本机 no-UE-first | `ue-automation-testing` | `ue-editor-automation-workflow` | [13-ue-automation-test-playbook.md](13-ue-automation-test-playbook.md)、[../dev/no-ue-first-tests.md](../dev/no-ue-first-tests.md)、[../dev/cpp-tests.md](../dev/cpp-tests.md) |
