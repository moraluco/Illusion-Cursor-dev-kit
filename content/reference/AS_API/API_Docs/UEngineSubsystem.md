...
UDynamicSubsystem → UEngineSubsystem → UAssetTagsSubsystem → UAudioAnalyzerSubsystem → UAudioDeviceNotificationSubsystem → UAudioWidgetSubsystem
...
```
STATIC FUNCTIONS StaticClass static UClass UEngineSubsystem::StaticClass()
```
