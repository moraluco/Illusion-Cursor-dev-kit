...
UInteractiveTool → USingleClickTool → UAddPatchTool → UAddPrimitiveTool → UMeshClickTool
...
```
STATIC FUNCTIONS StaticClass static UClass USingleClickTool::StaticClass()
```
