# UImportVertexColorOptions

**Visibility:** public

## Inheritance

UObject → UImportVertexColorOptions → OPTIONS → LODIndex
...
```
STATIC FUNCTIONS StaticClass static UClass UImportVertexColorOptions::StaticClass()
```
