...
UObject → UInteractiveToolBuilder → UAddPatchToolBuilder → UAddPrimitiveToolBuilder → UBspConversionToolBuilder → UClickDragToolBuilder
...
```
STATIC FUNCTIONS StaticClass static UClass UInteractiveToolBuilder::StaticClass()
```
