...
UAnyButtonInputBehavior → USingleClickInputBehavior → ULocalSingleClickInputBehavior
...
```
STATIC FUNCTIONS StaticClass static UClass USingleClickInputBehavior::StaticClass()
```
