...
UObject → UFXSystemAsset → UNiagaraSystem → UParticleSystem → PERFORMANCE → PoolPrimeSize
...
```
STATIC FUNCTIONS StaticClass static UClass UFXSystemAsset::StaticClass()
```
