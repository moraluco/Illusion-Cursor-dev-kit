...
UMovieSceneScriptingChannel → UMovieSceneScriptingObjectPathChannel
...
An array of UMovieSceneScriptingObjectPathKey contained by this channel. Returns all keys even if clipped by the owning section's boundaries or outside of the current sequence play range.
...
AddKey
UMovieSceneScriptingObjectPathKey AddKey(
...
STATIC FUNCTIONS
StaticClass
static UClass UMovieSceneScriptingObjectPathChannel::StaticClass()
