...
UObject → UContentBrowserDataSource → UContentBrowserAssetDataSource → UContentBrowserClassDataSource → UContentBrowserFileDataSource
...
```
STATIC FUNCTIONS StaticClass static UClass UContentBrowserDataSource::StaticClass()
```
