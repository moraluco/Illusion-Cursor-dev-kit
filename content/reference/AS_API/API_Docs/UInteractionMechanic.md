...
UObject → UInteractionMechanic → UCollectSurfacePathMechanic → UConstructionPlaneMechanic → UCurveControlPointsMechanic → UDragAlignmentMechanic
...
```
STATIC FUNCTIONS StaticClass static UClass UInteractionMechanic::StaticClass()
```
