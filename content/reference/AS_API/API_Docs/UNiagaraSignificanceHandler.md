...
UObject → UNiagaraSignificanceHandler → UNiagaraSignificanceHandlerAge → UNiagaraSignificanceHandlerDistance
...
```
STATIC FUNCTIONS StaticClass static UClass UNiagaraSignificanceHandler::StaticClass()
```
