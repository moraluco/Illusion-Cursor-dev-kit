...
UNiagaraDataInterfaceRWBase → UNiagaraDataInterfaceRenderTargetCube
...
```
STATIC FUNCTIONS StaticClass static UClass UNiagaraDataInterfaceRenderTargetCube::StaticClass()
```
