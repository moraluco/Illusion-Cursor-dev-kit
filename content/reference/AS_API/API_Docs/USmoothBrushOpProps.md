...
UBaseSmoothBrushOpProps → USmoothBrushOpProps → SMOOTHBRUSH → Falloff

## Description

float32 Falloff Amount of falloff to apply (0.0
...
```
STATIC FUNCTIONS StaticClass static UClass USmoothBrushOpProps::StaticClass()
```
