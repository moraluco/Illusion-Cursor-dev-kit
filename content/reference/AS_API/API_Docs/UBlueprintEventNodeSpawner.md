...
UBlueprintNodeSpawner → UBlueprintEventNodeSpawner → UBlueprintBoundEventNodeSpawner
...
```
STATIC FUNCTIONS StaticClass static UClass UBlueprintEventNodeSpawner::StaticClass()
```
