...
UMovieSceneScriptingChannel → UMovieSceneScriptingFloatChannel
...
```
ERichCurveExtrapolation PostInfinityExtrapolation PreInfinityExtrapolation ERichCurveExtrapolation PreInfinityExtrapolation Default float32 Default
```
...
AddKey
UMovieSceneScriptingFloatKey AddKey(
...
STATIC FUNCTIONS
StaticClass
static UClass UMovieSceneScriptingFloatChannel::StaticClass()
