...
UObject → UInputBehavior → UAnyButtonInputBehavior → UKeyAsModifierInputBehavior → UMouseHoverBehavior → USingleKeyCaptureBehavior
...
```
STATIC FUNCTIONS StaticClass static UClass UInputBehavior::StaticClass()
```
