...
UMovieSceneEntitySystem → UMovieSceneBlenderSystem → UMovieScenePiecewiseBoolBlenderSystem → UMovieScenePiecewiseByteBlenderSystem → UMovieScenePiecewiseDoubleBlenderSystem → UMovieScenePiecewiseEnumBlenderSystem
...
```
STATIC FUNCTIONS StaticClass static UClass UMovieSceneBlenderSystem::StaticClass()
```
