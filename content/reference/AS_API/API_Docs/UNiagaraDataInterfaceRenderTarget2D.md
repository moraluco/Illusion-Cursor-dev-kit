...
UNiagaraDataInterfaceRWBase → UNiagaraDataInterfaceRenderTarget2D

## Description

RENDER TARGET MipMapGeneration ENiagaraMipMapGeneration MipMapGeneration

Controls if and when we generate mips for the render target.

MipMapGenerationType ENiagaraMipMapGenerationType MipMapGenerationType OverrideRenderTargetFormat ETextureRenderTargetFormat OverrideRenderTargetFormat
...
```
STATIC FUNCTIONS StaticClass static UClass UNiagaraDataInterfaceRenderTarget2D::StaticClass()
```
