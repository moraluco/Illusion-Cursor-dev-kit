...
USoundEffectSourcePreset → USourceEffectMidSideSpreaderPreset
...
```
const FSourceEffectMidSideSpreaderSettings& GetSettings()const
```

### STATIC FUNCTIONS

```
STATIC FUNCTIONS StaticClass static UClass USourceEffectMidSideSpreaderPreset::StaticClass()
```
