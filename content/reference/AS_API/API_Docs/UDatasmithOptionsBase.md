...
UObject → UDatasmithOptionsBase → UDatasmithCommonTessellationOptions → UDatasmithImportOptions
...
```
STATIC FUNCTIONS StaticClass static UClass UDatasmithOptionsBase::StaticClass()
```
