...
UMovieSceneEntitySystem → UMovieSceneDeferredComponentMovementSystem
...
```
STATIC FUNCTIONS StaticClass static UClass UMovieSceneDeferredComponentMovementSystem::StaticClass()
```
