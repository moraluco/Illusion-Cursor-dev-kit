...
FWidgetAnimationDynamicEvent → VARIABLES → FunctionName
...
```
void Execute()const ExecuteIfBound
```
...
```
FWidgetAnimationDynamicEvent& opAssign(FWidgetAnimationDynamicEvent Other)
```
