...
UInputBehavior → UAnyButtonInputBehavior → UClickDragInputBehavior → UMouseWheelInputBehavior → UMultiClickSequenceInputBehavior → UScalableSphereGizmoInputBehavior
...
@todo spatial controllers @todo support tablet fingers @todo support gamepad?

### STATIC FUNCTIONS

```
STATIC FUNCTIONS StaticClass static UClass UAnyButtonInputBehavior::StaticClass()
```
