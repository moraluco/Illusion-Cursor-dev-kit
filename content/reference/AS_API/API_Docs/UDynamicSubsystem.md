...
USubsystem → UDynamicSubsystem → UAudioEngineSubsystem → UEditorSubsystem → UEngineSubsystem
...
```
STATIC FUNCTIONS StaticClass static UClass UDynamicSubsystem::StaticClass()
```
