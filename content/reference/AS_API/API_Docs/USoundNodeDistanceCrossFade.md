...
USoundNode → USoundNodeDistanceCrossFade → USoundNodeParamCrossFade
...
You have a gun that plays a fire sound.  At long distances you want a different sound than if you were up close.  So you use a SoundNodeDistanceCrossFade which will calculate the distance a listener is from the sound and play either:  short distance, long distance, mix of short and long sounds.
...
```
STATIC FUNCTIONS StaticClass static UClass USoundNodeDistanceCrossFade::StaticClass()
```
