...
UNiagaraDataInterfaceRWBase → UNiagaraDataInterfaceRenderTarget2DArray
...
```
STATIC FUNCTIONS StaticClass static UClass UNiagaraDataInterfaceRenderTarget2DArray::StaticClass()
```
